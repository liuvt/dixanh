...
namespace dixanh.Data.Migrations
{
    ...
    [Migration("20260207082740_FK_VehiclePlate_VehicleChassic_Status")]
    partial class FK_VehiclePlate_VehicleChassic_Status
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dixanh.Libraries.Models.Vehicle", b =>
                {
                    ...
                    b.HasIndex("CurrentVehicleCode");

                    b.HasIndex("LicensePlate");

                    b.HasIndex("StatusId");

                    b.HasIndex("LicensePlate", "ChassisNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("dixanh.Libraries.Models.VehicleCodeHistory", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .IsUnicode(false)
                    ...
                    b.HasIndex("OperatingArea", "VehicleCode")
                        .IsUnique()
                        .HasDatabaseName("UX_VehicleCodeHistories_ActiveCodePerArea")
                        .HasFilter("[ValidTo] IS NULL");

                    b.ToTable("VehicleCodeHistories", (string)null);
                });
            ...
            modelBuilder.Entity("dixanh.Libraries.Models.Vehicle", b =>
                {
                    ...
                    b.Navigation("VehicleCodeHistories");
                });
